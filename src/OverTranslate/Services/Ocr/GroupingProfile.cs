    ...
    bool RefuseSpeakerLineStarts)
{
    ...
    /// <summary>
    /// Historical rotated-frame grouping, retained for offline comparisons and fixtures.
    /// Native vertical OCR groups columns directly and does not use a horizontal profile.
    /// </summary>
