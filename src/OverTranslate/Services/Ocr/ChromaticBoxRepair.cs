...
/// the boxes that share height with the widest one on their line, which must be wide, continuous,
/// substantial, and hold coloured ink that no box covers. Across 500 captures that changes five:
/// three rows read whole that used to come back in pieces, one exclamation mark that comes back
/// full-width as the page has it, and one frame of noise a subtitle dump should not have read at
/// all, whose noise changes shape.</para>
///
